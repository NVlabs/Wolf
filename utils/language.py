...
# def chat_history_to_prompt_new(self, query, history):
#     prompt = "<EOI>last frame: "
#     for i, (old_query, response) in enumerate(history):
#         prompt += "last frame: " + response
...
_history_to_prompt = {
    ...
    "chat": chat_history_to_prompt_new, #chat_history_to_prompt
